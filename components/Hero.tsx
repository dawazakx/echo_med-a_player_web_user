...
const PressableOpacity: React.FC = ({ children }) => {
  return (
    <div className="relative">
      <button className="bg-blue-600 text-white hover:bg-blue-200 border border-white border-opacity-20 px-6 py-3 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-700 focus:ring-opacity-50 transition-colors duration-300">
        {children}
      </button>
    </div>
  )
